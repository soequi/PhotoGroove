			...
			[
				...
				_List_fromArray(
					[
						...
						A3($author$project$PhotoGroove$viewFilter, $author$project$PhotoGroove$SlidHue, 'Ripple', model.ripple),
						A3($author$project$PhotoGroove$viewFilter, $author$project$PhotoGroove$SlidHue, 'Noise', model.noise)
					])),
				A2(
				$elm$html$Html$h3,
				_List_Nil,
